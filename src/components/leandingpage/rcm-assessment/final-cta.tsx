...
const appointmentShape = "../../images/home/appointment-shape.png";

const FinalCTA = () => {
  return (
    <section className="tw-py-20 tw-px-4 md:tw-px-8 lg:tw-px-16  tw-overflow-hidden tw-relative">
      <div className="appointment-one__bg !tw-z-[-10]">
        <div className="appointment-one__bg__inner"></div>
        <div className="appointment-one__bg__shape">
          <div className="appointment-one__bg__shape__1">
            <div className="appointment-one__bg__shape__2"></div>
          </div>
        </div>
      </div>
      <motion.div
