...
const footerBg = "/images/background/footer.jpg";
const ptImg1 = "/images/shap/wave-blue.png";
const ptImg2 = "/images/shap/circle-dots.png";
const ptImg3 = "/images/shap/plus-blue.png";
const ptImg4 = "/images/shap/wave-blue.png";
          ...
          <div className="row">
            ...
            {/* <div className="col-xl-3 col-lg-3 col-6">
                    <div className="widget footer_widget">
                        ...
                        <ul>
                            <li><Link href="/medical-claim-billing"><span>Medical claim billing</span></Link></li>
                            <li><Link href="/radiology-billing-services"><span>Radiology billing services</span></Link></li>
                            <li><Link href="/cardiology-medical-billing"><span>Cardiology medical billing</span></Link></li>
                        </ul>
                    </div>
                </div> */}
