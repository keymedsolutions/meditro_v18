...
const testimonials = [
  {
    text: "Their billing expertise has made my practice more profitable and stress-free. I no longer worry about claim rejections!",
    name: "Dr. Amanda Lee",
    spec: "Family Medicine"
  },
  {
    text: "A game-changer! Their proactive approach to denial management and credentialing saved us time and increased revenue.",
    name: "Dr. Kevin Patel",
    spec: "Orthopaedic Surgeon"
  },
  {
    text: `Professional, efficient, and highly knowledgeable. The best decision I made for my practice’s financial health!`,
...
const Testimonials = () => {
  ...
  return (
    <section className="tw-relative section-area !tw-py-16 section-sp3 testimonial-wraper tw-overflow-hidden">
      ...
      <SectionHeading title="Trusted by 300+ Healthcare Providers" subtitle="" showUnderline={false} />
