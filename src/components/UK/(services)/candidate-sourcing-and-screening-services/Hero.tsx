    ...
    <section className="tw-relative tw-w-full tw-overflow-hidden tw-bg-[#f3f6fc] tw-py-20 lg:tw-py-28 tw-flex tw-items-center">
      ...
      <div className="tw-container tw-relative tw-z-10 tw-mx-auto tw-px-6 md:tw-px-10 lg:tw-px-14 tw-max-w-5xl">
        ...
        >
          ...
          {/* TITLE */}
          <h1 className="tw-text-3xl sm:tw-text-4xl lg:tw-text-5xl tw-font-bold tw-text-accent-400 tw-leading-[1.25] tw-mb-6">
            Candidate Sourcing & Screening Services Built for Speed, Accuracy &
            Scalability
          </h1>

          {/* DESCRIPTION FULL TEXT – EXACTLY AS YOU WROTE */}
          <p className="tw-text-base sm:tw-text-lg tw-text-white tw-leading-relaxed tw-mb-6">
            Recruiting the right talent shouldn’t feel overwhelming. But the
            reality is, finding qualified candidates can be overwhelming. That’s
            where we step in. Our Candidate Sourcing & Screening Services are
            designed to take the stress out of hiring, delivering the right
            candidates quickly, accurately, and cost-effectively.
          </p>
          ...
          <div className="tw-space-y-3 tw-mb-8">
            <p className="tw-text-base tw-text-white tw-leading-relaxed">
              • 24–48-hour candidate shortlist delivery: No more waiting weeks
              for results.
            </p>
            <p className="tw-text-base tw-text-white tw-leading-relaxed">
            ...
            <p className="tw-text-base tw-text-white tw-leading-relaxed">
              • Sector-specific expertise: From tech to healthcare, we’ve got
              you covered.
            </p>
            <p className="tw-text-base tw-text-white tw-leading-relaxed">
              • UK-focused quality + global reach: Local precision with
              worldwide talent access.
            </p>
          </div>

          {/* FULL SENTENCE (YOU SAID DO NOT CUT) */}
          <p className="tw-text-lg tw-font-semibold tw-text-white tw-mb-8">
            Ready to transform your hiring process?
          </p>

          {/* CTA BUTTONS – FULL TEXT EXACTLY AS WRITTEN */}
          <div className="tw-flex tw-flex-wrap tw-gap-4">
            <button className="tw-bg-accent-900 tw-text-white tw-px-6 tw-py-3 tw-rounded-full tw-font-medium tw-flex tw-items-center tw-gap-2 hover:tw-bg-accent-700 tw-transition-all tw-border-none">
