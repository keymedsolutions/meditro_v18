...
import { ShieldCheck, TrendingUp, Sparkles, LineChart } from "lucide-react";

const ProofOfCredibilitySection: React.FC = () => {
  return (
          ...
          <div className="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 tw-gap-5 tw-mb-8">
            ...
            >
              <div className="tw-h-9 tw-w-9 tw-rounded-2xl tw-flex tw-items-center tw-justify-center tw-bg-white">
                <TrendingUp className="tw-w-4 tw-h-4 tw-text-accent-600" />
              </div>
            ...
            >
              ...
              <p className="tw-text-sm tw-text-slate-800 tw-leading-relaxed tw-mb-0">
                <span className="tw-font-semibold">96% quality acceptance</span>
              </p>
            </div>
            ...
            >
              <div className="tw-h-9 tw-w-9 tw-rounded-2xl tw-flex tw-items-center tw-justify-center tw-bg-white">
                <LineChart className="tw-w-4 tw-h-4 tw-text-accent-600" />
              </div>
              <p className="tw-text-sm tw-text-slate-800 tw-leading-relaxed tw-mb-0">
                <span className="tw-font-semibold">70% cost savings</span>
              </p>
            </div>
            ...
            >
              ...
              <p className="tw-text-sm tw-text-slate-800 tw-leading-relaxed tw-mb-0">
                <span className="tw-font-semibold">
                  500,000+ profiles screened annually
                </span>
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="tw-flex tw-flex-wrap tw-gap-3">
              <button
                ...
                style={{ border: "1px solid rgba(226,232,240,0.9)" }}
              >
                Request a Free Sample of 10 Candidates
              </button>
...
export default ProofOfCredibilitySection;
