...
const AdministrativeServices: React.FC = () => {
  return (
    <section className="tw-relative tw-isolate tw-overflow-hidden tw-bg-white tw-text-slate-900 tw-py-16 md:tw-py-24 lg:tw-py-28">
      ...
      <div className="tw-relative tw-z-10 tw-mx-auto tw-max-w-6xl tw-px-4 md:tw-px-6 lg:tw-px-8">
        <motion.div
          className="tw-grid tw-items-center tw-gap-10 lg:tw-grid-cols-[minmax(0,1.35fr)_minmax(0,1fr)]"
        ...
        >
          ...
          <div className="tw-space-y-8">
            ...
            <motion.div
              ...
              style={{
                borderLeft: "1.5px solid var(--accent-500)", // ← ADDED
              }}
            ...
            >
              <h2 className="tw-text-xl md:tw-text-2xl tw-font-semibold tw-leading-snug tw-text-slate-900">
                What Are Back Office and Administrative Services?
              </h2>
              <p className="tw-text-sm md:tw-text-base tw-leading-relaxed tw-text-slate-600 tw-mt-2">
                Back office and administrative services include essential tasks
                that keep a business running smoothly behind the scenes. This
                covers functions like data entry, financial administration, and
                HR support. For scaling businesses across the UK and globally,
                outsourcing these tasks is vital to maintain efficiency and
                focus on core growth. We at Key Medsolutions UK, provide
                tailored Back Office Administration Services for various
                industries.
              </p>
            </motion.div>
            ...
            {/* Block 2 */}
            <motion.div
              className="tw-rounded-3xl tw-bg-white/90 tw-backdrop-blur-xl tw-shadow-[0_18px_60px_rgba(15,23,42,0.10)] tw-p-6 md:tw-p-8 tw-space-y-4 tw-border-transparent"
              style={{
                borderLeft: "1.5px solid var(--accent-500)", // ← ADDED
              }}
              variants={itemVariants}
            ...
            >
              <h2 className="tw-text-xl md:tw-text-2xl tw-font-semibold tw-leading-snug tw-text-slate-900">
                Why Back Office Support Matters for UK &amp; Global Companies
              </h2>
              <p className="tw-text-sm md:tw-text-base tw-leading-relaxed tw-text-slate-600 tw-mt-2">
                Managing in-house administrative tasks can drain valuable
                resources. Modern companies often face challenges like lost time
                on repetitive tasks, increased operational costs, compliance
                risks, and the high expense of hiring and training staff. Our
                back office support services solve these problems by providing
                an efficient, expert extension of your team, allowing you to
          ...
          >
            <div className="tw-relative tw-aspect-[4/5] md:tw-aspect-[4/5] lg:tw-h-[420px] tw-w-full">
              ...
              >
                <Image
                  src="/assets/images/back-office-and-administrative-services/back-office-team.jpg" // <- secondary image (optional)
              ...
              <motion.div
                ...
                viewport={{ once: true, amount: 0.2 }}
              >
                <div className="tw-h-10 tw-w-10 tw-rounded-2xl tw-bg-accent-400/90 tw-shadow-[0_0_0_10px_rgba(56,189,248,0.18)]" />
