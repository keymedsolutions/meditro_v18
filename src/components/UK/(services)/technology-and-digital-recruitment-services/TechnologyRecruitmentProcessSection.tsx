  ...
  return (
    <section className="tw-relative tw-w-full tw-overflow-hidden tw-bg-[#f6f9ff] tw-py-24">
      ...
      <div className="tw-container tw-relative tw-z-10 tw-mx-auto tw-max-w-7xl tw-px-4 md:tw-px-8">
        ...
        {/* RADIAL PROCESS SYSTEM */}
        <div className="tw-relative tw-grid tw-grid-cols-1 lg:tw-grid-cols-2 tw-gap-16 tw-items-center">
          {[
            {
            ...
            },
            {
              ...
              text: ["As a leading Candidate Screening company, we combine:"],
              list: [
                "AI-sourcing tools",
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="tw-relative tw-h-full tw-rounded-[28px] tw-bg-white/85 tw-backdrop-blur-lg tw-p-6"
              style={{
                border: "1px solid rgba(226,232,240,0.9)",
              }}
            >
              <h3 className="tw-text-xl sm:tw-text-2xl tw-font-semibold tw-text-slate-900 tw-mt-3 tw-mb-5">
                {step.title}
              </h3>
