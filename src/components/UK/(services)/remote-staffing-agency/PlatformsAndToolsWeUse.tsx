...
const PlatformsAndToolsWeUse: React.FC = () => {
  const sectors = [
    {
    ...
    {
      icon: <LineChart className="tw-w-5 tw-h-5" />,
      text: "Zoom",
    },
    { icon: <HeartPulse className="tw-w-5 tw-h-5" />, text: "G-Suite" },
    {
      icon: <BriefcaseBusiness className="tw-w-5 tw-h-5" />,
      text: "Asana",
    },
    { icon: <Cog className="tw-w-5 tw-h-5" />, text: "Jira" },
    { icon: <ShoppingBag className="tw-w-5 tw-h-5" />, text: "Hubstaff" },
  ];
      ...
      <div className="tw-container tw-relative tw-z-10 tw-mx-auto tw-max-w-6xl tw-px-4 md:tw-px-8">
        ...
        >
          ...
          <p className="tw-text-sm sm:tw-text-base tw-text-slate-700 tw-leading-relaxed tw-mb-4">
            As one of the best platforms for remote staffing agencies in the UK,
            we use modern communication and task management tools to keep your
            remote team connected, accountable, and productive worldwide.
          </p>
        </motion.div>
        ...
        >
          ...
          >
              ...
              {sectors.map((item, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <p className="!tw-mb-0 tw-self-center tw-text-sm tw-font-semibold tw-text-slate-900">
                      {item.text}
                    </p>
                  </div>
                </motion.div>
            ...
            >
              These platforms ensure clear communication, real-time
...
export default PlatformsAndToolsWeUse;
