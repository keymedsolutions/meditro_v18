...
const IndustriesWeSupport = () => {
  const industries = [
    ...
    { title: "Real Estate" },
    { title: "Ecommerce" },
    { title: "Creative Agencies and Startups" },
  ];
  ...
  return (
    <section className="tw-w-full tw-bg-white tw-py-16">
      <div className="tw-container tw-mx-auto tw-flex tw-flex-col tw-gap-y-16">
        ...
        >
          Our flexibility makes us ideal for companies that want agile teams
          without the cost and complexity of traditional hiring.
        </motion.p>
      </div>
    </section>
  );
