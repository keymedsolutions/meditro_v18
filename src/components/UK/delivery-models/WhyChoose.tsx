...
import { ShieldCheck, Globe2, Layers, Briefcase, SlidersHorizontal, Cpu, Headset } from "lucide-react";
          ...
          <div className="tw-flex tw-flex-col tw-items-center tw-text-center tw-mb-8">
            ...
            <div className="tw-inline-flex tw-items-center tw-gap-2 tw-mb-3">
              <p className="tw-text-sm tw-font-semibold tw-tracking-[0.18em] tw-uppercase tw-text-accent-700 tw-mb-0">
                Why Choose Key Medsolutions UK for Your Recruitment Delivery
                Model?
              </p>
            </div>

            <p className="tw-text-sm sm:tw-text-base tw-text-slate-700 tw-max-w-2xl">
              We’re trusted by startups, agencies, and enterprises in the UK and
              worldwide for our proven results.
            </p>
          </div>
          ...
          <div className="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 tw-gap-5 tw-mb-8">
            ...
            >
              <div className="tw-h-9 tw-w-9 tw-rounded-2xl tw-flex tw-items-center tw-justify-center tw-bg-white">
                <Globe2   className="tw-w-4 tw-h-4 tw-text-accent-600" />
              </div>
              <p className="tw-text-sm tw-text-slate-800 tw-leading-relaxed tw-mb-0">
                <span className="tw-font-semibold">
                  UK expertise + global execution
                </span>
              </p>
            </div>
            ...
            >
              <div className="tw-h-9 tw-w-9 tw-rounded-2xl tw-flex tw-items-center tw-justify-center tw-bg-white">
                <Layers className="tw-w-4 tw-h-4 tw-text-accent-600" />
              </div>
              <p className="tw-text-sm tw-text-slate-800 tw-leading-relaxed tw-mb-0">
                <span className="tw-font-semibold">
            ...
            >
              <div className="tw-h-9 tw-w-9 tw-rounded-2xl tw-flex tw-items-center tw-justify-center tw-bg-white">
                <Briefcase  className="tw-w-4 tw-h-4 tw-text-accent-600" />
              </div>
              <p className="tw-text-sm tw-text-slate-800 tw-leading-relaxed tw-mb-0">
                <span className="tw-font-semibold">
                  10+ years combined recruiter experience
                </span>
              </p>
            </div>
            ...
            >
              <div className="tw-h-9 tw-w-9 tw-rounded-2xl tw-flex tw-items-center tw-justify-center tw-bg-white">
                <SlidersHorizontal  className="tw-w-4 tw-h-4 tw-text-accent-600" />
              </div>
              <p className="tw-text-sm tw-text-slate-800 tw-leading-relaxed tw-mb-0">
                <span className="tw-font-semibold">
                  Scalable, customisable frameworks
                </span>
              </p>
            </div>
            ...
            >
              <div className="tw-h-9 tw-w-9 tw-rounded-2xl tw-flex tw-items-center tw-justify-center tw-bg-white">
                <ShieldCheck  className="tw-w-4 tw-h-4 tw-text-accent-600" />
              </div>
              <p className="tw-text-sm tw-text-slate-800 tw-leading-relaxed tw-mb-0">
                <span className="tw-font-semibold">
                  Transparent pricing, zero-risk onboarding
                </span>
              </p>
            </div>
            ...
            >
              <div className="tw-h-9 tw-w-9 tw-rounded-2xl tw-flex tw-items-center tw-justify-center tw-bg-white">
                <Cpu  className="tw-w-4 tw-h-4 tw-text-accent-600" />
              </div>
              <p className="tw-text-sm tw-text-slate-800 tw-leading-relaxed tw-mb-0">
                <span className="tw-font-semibold">
                  Tech-enabled hiring with automation
                </span>
              </p>
            </div>
            ...
            >
              <div className="tw-h-9 tw-w-9 tw-rounded-2xl tw-flex tw-items-center tw-justify-center tw-bg-white">
                <Headset  className="tw-w-4 tw-h-4 tw-text-accent-600" />
              </div>
              <p className="tw-text-sm tw-text-slate-800 tw-leading-relaxed tw-mb-0">
                <span className="tw-font-semibold">
          ...
          >
            ...
            >
              <p className="tw-text-sm sm:tw-text-base tw-font-semibold tw-mb-1 tw-text-white">
                Ready to Build a Smarter, Scalable Recruitment Engine?
              </p>
            </div>

            <p className="tw-text-white tw-text-center">
              Choose the right Recruitment Delivery Models for your business,
              flexible, cost-effective, and tailored to your hiring needs. Let’s
              make recruitment simpler, faster, and smarter.
            </p>
            <div className="tw-flex tw-flex-wrap tw-gap-3">
              ...
              <button className="tw-inline-flex tw-items-center tw-justify-center tw-rounded-full tw-px-4 tw-py-2 tw-text-xs sm:tw-text-sm tw-font-semibold tw-bg-transparent tw-text-white tw-border-none tw-shadow-none tw-transition tw-duration-200 hover:tw-bg-white/10 border tw-border-white">
                Download Our Delivery Model Brochure
              </button>
            </div>
          </motion.div>
        </motion.div>
