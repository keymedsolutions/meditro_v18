...
const HiringProcess = () => {
  ...
  return (
    <div className="tw-relative tw-py-20  tw-bg-gradient-to-br tw-from-slate-50 tw-via-white tw-to-blue-50/50 tw-overflow-hidden">
      ...
      <div className="tw-mt-10 tw-z-20 lg:tw-hidden sm:tw-px-0 tw-px-2">
        <Carousel
        ...
        >
          <CarouselContent>
           ...
           <CarouselPrevious
            className="tw-absolute -tw-bottom-10 sm:tw-top-1/2 tw-right-16 tw-left-auto tw-top-auto tw-translate-y-0 tw-translate-x-0"
          />
          <CarouselNext
            className="tw-absolute -tw-bottom-10 sm:tw-top-1/2 tw-right-4 tw-left-auto tw-top-auto tw-translate-y-0 tw-translate-x-0"
          />
        </Carousel>
      </div>
    </div>
