  ...
  const getColorClasses = (colorName: string) => {
    ...
    > = {
      primary: {
        ...
        hover: "group-hover:tw-bg-primary/20",
      },
      secondary: {
        bg: "tw-bg-secondary/10",
        text: "tw-text-secondary",
        hover: "group-hover:tw-bg-secondary/20",
      },
      success: {
        bg: "tw-bg-success/10",
        text: "tw-text-success",
        hover: "group-hover:tw-bg-success/20",
      },
      info: {
        bg: "tw-bg-info/10",
        text: "tw-text-info",
        hover: "group-hover:tw-bg-info/20",
      },
      warning: {
        bg: "tw-bg-warning/10",
        text: "tw-text-warning",
        hover: "group-hover:tw-bg-warning/20",
      },
      danger: {
        bg: "tw-bg-danger/10",
        text: "tw-text-danger",
        hover: "group-hover:tw-bg-danger/20",
      },
    };
    ...
    <Card className="border tw-shadow-lg hover:tw-shadow-xl tw-transition-all tw-transform hover:-tw-translate-y-2 tw-overflow-hidden tw-group">
      ...
      <CardContent className="tw-p-6 tw-relative tw-z-10">
        <div className="tw-flex tw-flex-col tw-items-center tw-text-center">
          ...
          > */}
          <div
            className={` work-num-bx  !tw-text-[60px] !tw-mb-0 tw-text-${color} ${stroke}`}
          >
            {number}
          </div>
          {/* </div> */}
