    ...
    >
      ...
      <div className="tw-p-6 tw-relative tw-overflow-hidden">
        ...
        <div className="tw-flex tw-items-center tw-justify-between tw-mb-4 tw-relative tw-z-10">
          ...
          <motion.div
            className="tw-text-4xl tw-font-bold tw-font-bold tw-bg-gradient-to-r tw-from-blue-600 tw-via-purple-600 tw-to-pink-500 tw-bg-clip-text tw-text-transparent"
       ...
       {description &&  <p className="tw-text-sm tw-text-gray-500 tw-mt-1 tw-relative tw-z-10">{description}</p>}
      </div>
    </motion.div>
  )
}
