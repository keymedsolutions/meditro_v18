        ...
        <div className="row">
            <div className="col-lg-12">
                ...
                <div className="infographic-div infographic-div-mobile">
                    {
                        aspects.map((aspect)=>(
                            <div key={aspect.id} className={`figure__product ${aspect.color}`} >
                                <div className="figure__productContent">
                                    <h3 className="figure__productName tw-font-display tw-text-center tw-p-2 tw-text-lg">{aspect.title}</h3>
                                    <p className="tw-text-wrap tw-text-white">{aspect.description}</p>
                                </div>
                                <div className="figure__productIconBox count-num">{aspect.id}</div>
                            </div>
                        ))
                    }
                </div>
