...
export function ExpertMedicalBilling() {
    ...
    return (
        <>
            ...
            <section
                className="tw-py-16 tw-mt-20  tw-bg-gradient-to-br tw-from-keymed-50 tw-to-teal-50 tw-relative tw-overflow-hidden"
            >
                ...
                <div className="tw-text-center tw-mb-20">
                    <SectionHeading title="Expert Medical Billing & Coding Services to Maximize Your Revenue" subtitle="Expert" />
                </div>
                ...
                description='Let’s Maximize Your Medical Practice Revenue!'
                />
            </section>
        </>
    );
