...
export function ExpertMedicalBilling() {
  const itemVariants = {
                  ...
                  <div className="tw-grid tw-grid-cols-1 md:tw-grid-cols-3 tw-gap-8">
                    ...
                    <div className="tw-col-span-2 tw-flex tw-flex-col tw-justify-center">
                      ...
                      >
                        ...
                        >
                          At Key MedSolutions, we’re more than a Medical Coding
                          Outsourcing Company; we’re a committed partner
                          dedicated to your success. By leveraging our
                          expertise, technology, and customized solutions, we
                          empower healthcare providers to enhance operational
                          efficiency and achieve greater financial outcomes.
                        </motion.p>
                        ...
                        <motion.p
                          ...
                          className="tw-text-gray-700 tw-mb-6 tw-leading-relaxed"
                        >
                          Take the next step today. Contact Key MedSolutions to
                          learn more about our end-to-end medical coding
                          services that simplify processes, improve compliance,
