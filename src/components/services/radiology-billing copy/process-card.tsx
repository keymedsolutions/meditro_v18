...
export function ProcessCard({ title, description, step, icon }: ProcessCardProps) {
  return (
    <motion.div
      className="tw-bg-white tw-p-6 tw-rounded-xl tw-shadow-md border tw-border-blue-100 tw-relative tw-overflow-hidden"
    ...
    >
      ...
      <p className="tw-text-gray-700 sm:tw-ml-16">{description}</p>
    </motion.div>
  )
}
