...
const testimonials = [
    {
        text: "Our physician billing procedure has been totally revolutionized by Key MedSolutions. Their knowledge has improved our overall revenue flow and decreased claim denials.",
        name: "Dr. Jennifer M.",
        spec: "Internal Medicine Physician"
    },
    {
        text: "Their staff is very informed and proactive. We have seen a considerable increase in collections and a decrease in billing errors since collaborating with Key MedSolutions.",
        name: "David L.",
        spec: "Practice Administrator"
    },
    {
        text: "Previously, we had trouble with insurance denials, but Key MedSolutions' denial management techniques have significantly improved our situation. Payments are now received more quickly and with fewer issues.",
        name: "Dr. Andrew S.",
    ...
    return (
        <section className="tw-relative section-area !tw-py-16 section-sp3 testimonial-wraper tw-overflow-hidden">
            ...
            <div className="tw-container">
                <SectionHeading title="What Our Clients Say About Working with Us" subtitle="" />
