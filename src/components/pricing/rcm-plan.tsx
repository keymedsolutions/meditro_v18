        ...
        <>
            ...
            <div className="tw-grid lg:tw-grid-cols-3 tw-gap-8 tw-mb-16">
                ...
                <Card
                    ...
                    className="tw-relative tw-shadow-lg hover:tw-shadow-xl tw-transition-all tw-duration-300"
                >
                    ...
                    <CardContent className="tw-space-y-4">
                        <p className="tw-text-sm tw-text-gray-600 tw-mb-4">
                            This is our most requested service. It provides a detailed, fully
                            customized insurance breakdown — designed to give you total
                            clarity on coverage, helping you avoid delays or denials.
                        </p>
                ...
                <Card
                    ...
                    className="tw-shadow-lg tw-hover:shadow-xl tw-transition-all tw-duration-300"
                >
                    <CardHeader className="tw-text-center tw-pb-4">
                        <div className="tw-text-4xl tw-font-bold tw-text-slate-600 tw-mb-2">
                            $2
                        </div>
                        <CardTitle className="tw-text-xl tw-mb-2 !tw-font-bold tw-bg-gradient-to-r tw-from-slate-600 tw-to-primary-600 tw-bg-clip-text tw-text-transparent">
                            Eligibility-Only Verification
                        </CardTitle>
                        <CardDescription className="tw-text-primary-600 tw-font-bold !tw-text-[17px]">
                            Patient Data Only
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="tw-space-y-4">
                        <p className="tw-text-sm tw-text-gray-600 tw-mb-4">
                            Need a quick coverage check? This is your go-to for returning patients or simple appointments.
                            ...
                            {[
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <span className="tw-text-sm tw-text-slate-700">{row}</span>
                                    </div>
                                );
                            })}
                        </div>
                ...
                <Card
                    ...
                    className="tw-shadow-lg hover:tw-shadow-xl tw-transition-all tw-duration-300 tw-border-2 tw-border-purple-200"
                >
                    <CardHeader className="tw-text-center tw-pb-4">
                    ...
                    <CardContent className="tw-space-y-4">
                        <p className="tw-text-sm tw-text-gray-600 tw-mb-4">
                            Running a high-volume practice? Don’t have an in-house insurance expert? We’ve got you covered. Hire a dedicated verification specialist who works exclusively for your clinic.

                        </p>

                        <div className="tw-space-y-4">
                            <div className="tw-border tw-border-purple-200 tw-rounded-lg tw-p-4" style={{
                        ...
                        <div className="tw-bg-gradient-to-r tw-from-slate-100 tw-to-purple-100 !tw-border-2 !tw-border-slate-300 tw-rounded-xl tw-p-4 tw-shadow-inner">
                            <p className="tw-text-slate-800 tw-font-bold tw-text-sm">
                                <strong>Note:</strong> Monthly agent plans are priced for staffing only and do not include
