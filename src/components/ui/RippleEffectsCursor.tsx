...
export default function SplashCursor({
  ...
  return (
    <div className="tw-fixed tw-top-0 tw-left-0 tw-z-50 tw-pointer-events-none tw-w-full tw-h-full">
      <canvas ref={canvasRef} id="fluid" className="tw-w-screen tw-h-screen tw-block"></canvas>
    </div>
  );
}
