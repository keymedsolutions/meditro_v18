...
const CallToActionSection = ({ handleShow, title, description }: PropsType) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="tw-container tw-rounded-xxl tw-h-auto tw-w-full tw-flex tw-justify-center tw-items-center md:tw-py-40 tw-py-20"
    >
      <motion.div
