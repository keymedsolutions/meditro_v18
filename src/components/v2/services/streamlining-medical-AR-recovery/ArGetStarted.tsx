...
export function ArGetStarted() {
  return (
    <section className="tw-py-20 tw-bg-gradient-to-br tw-from-blue-50 tw-to-purple-50">
      <div className="tw-max-w-7xl tw-mx-auto tw-px-6 tw-text-center">
        ...
        >
          ...
          <p className="tw-text-xl tw-text-gray-600 tw-max-w-4xl tw-mx-auto tw-leading-relaxed tw-mb-8">
        ...
        >
          <div className="tw-bg-white tw-rounded-2xl tw-p-8 tw-shadow-lg tw-border tw-border-gray-100">
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
        >
          <p className="tw-text-lg tw-text-gray-600 tw-max-w-4xl tw-mx-auto tw-leading-relaxed">
