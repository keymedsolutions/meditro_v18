...
//         "Built-in coding validation to catch errors",
//         "Real-time tracking for complete claim visibility",
//       ],
...
//   return (
//     <section className="tw-py-20 tw-bg-gradient-to-br tw-from-background tw-to-muted/30">
...
//         >
//           <h2 className="tw-text-4xl tw-md:text-5xl tw-font-bold tw-text-foreground tw-mb-6 tw-font-sans">
//             Why Choose Key MedSolutions for Your Billing Needs?
//           </h2>
//           <div className="tw-w-24 tw-h-1 tw-bg-primary tw-mx-auto tw-rounded-full"></div>
//         </motion.div>

//         <div className="tw-grid tw-gap-8 tw-md:gap-12">
...
//               viewport={{ once: true }}
//               className={`tw-flex tw-flex-col tw-lg:flex-row tw-items-start tw-gap-8 ${
//                 index % 2 === 1 ? "tw-lg:flex-row-reverse" : ""
//               }`}
//             >
//               <div className="tw-flex-shrink-0">
//                 <div className="tw-w-20 tw-h-20 tw-bg-primary/10 tw-rounded-2xl tw-flex tw-items-center tw-justify-center tw-mb-4 tw-lg:mb-0">
...
//                   className="tw-bg-card tw-p-8 tw-rounded-3xl tw-shadow-lg border tw-border-border/50 tw-hover:shadow-xl tw-transition-all tw-duration-300"
//                 >
//                   <h3 className="tw-text-2xl tw-font-bold tw-text-foreground tw-mb-4 tw-font-sans">{feature.title}</h3>
//                   <p className="tw-text-muted-foreground tw-leading-relaxed tw-mb-4 tw-font-serif">
//                     {feature.description}
//                   </p>

//                   {feature.features && (
//                     <div className="tw-mb-4">
//                       <p className="tw-text-sm tw-font-semibold tw-text-foreground tw-mb-3 tw-font-sans">
//                         Our platform offers:
//                       </p>
...
//                             <span className="tw-text-muted-foreground tw-font-serif">{item}</span>
//                           </li>
//                         ))}
//                       </ul>
//                     </div>
...
//                   {feature.note && (
//                     <div className="tw-bg-primary/5 tw-p-4 tw-rounded-xl border-l-4 tw-border-primary">
//                       <p className="tw-text-foreground tw-font-medium tw-font-serif">{feature.note}</p>
//                     </div>
//                   )}
//                 </motion.div>
//               </div>
