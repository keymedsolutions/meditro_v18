...
export function WhoDoWeServe() {
  const features = [
    {
      title: "Independent medical clinics and specialty practices",
      number: "01",
      icon: Stethoscope,
    },
    {
      title:
        "Physician groups striving to improve their financial performance.",
      number: "02",
      icon: Users,
    },
    {
      title: "Multispecialty healthcare networks aiming for scalable growth.",
      number: "03",
      icon: Network,
    },
    {
      title:
        "Hospitals and healthcare systems manage intricate revenue cycle processes.",
      number: "04",
      icon: Hospital,
    },
    {
      title:
        "Billing and revenue cycle management companies seeking optimization.",
      number: "05",
      icon: DollarSign,
    },
  ];
