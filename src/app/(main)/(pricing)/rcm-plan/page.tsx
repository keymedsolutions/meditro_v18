...
const RCMPlan = () => {
  ...
  const WhyChooses = [
        {
            icon: "💡",
            label: " Real humans, not bots – every ticket is reviewed by a trained specialist",
    ...
    return (
        <div className="tw-page-content tw-bg-white">
            ...
            >
                <div className="tw-container plan-sections">
                    <div className="heading-bx text-center">
                        ...
                        <h2 className="tw-mb-4 tw-font-display tw-text-3xl tw-font-extrabold tw-tracking-tight sm:tw-text-3xl md:tw-text-4xl">
                            Key Medsolutions  –
                            <span className="tw-bg-gradient-to-r tw-from-purple-600 tw-to-primary tw-bg-clip-text tw-text-transparent">Transparent, Per-Ticket Pricing</span>
                        </h2>
                        <p>We keep things simple: each verification request counts as one ticket. A ticket equals one patient verification. Whether you need a full breakdown or just eligibility data, our pricing adjusts based on the depth of information and urgency of your request.
                        </p>
                    </div>
              ...
              <WhyChooseOurMedicalBilling title='Why Practices Trust Key Medsolutions' 
              data={WhyChooses}/>
