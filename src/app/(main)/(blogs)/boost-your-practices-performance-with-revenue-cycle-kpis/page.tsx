...
const BoostYourPracticeSPerformanceWithRevenueCycleKPIsPage = () => {

	const title = "Boost Your Practice's Performance with Revenue Cycle KPIs"
	const path = "/boost-your-practices-performance-with-revenue-cycle-kpis"
						...
						<div className="col-md-12 col-lg-10 col-xl-10 mb-30 mb-md-50">
							<div className="blog-card blog-single">
								<div className="post-media">
									<img src={blogGridPic2} alt="boost-your-practices-performance-with-revenue-cycle-kpis" />
								</div>
								<div className="info-bx">
									<ul className="post-meta">
										{/* <li className="author"><Link to="/blog-details"><img src={testPic3} alt=""/> Sonar Moyna</Link></li> */}
										<li className="date"><i className="far fa-calendar-alt"></i> 23 September 2023</li>
									</ul>
...
export default BoostYourPracticeSPerformanceWithRevenueCycleKPIsPage;
